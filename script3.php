...
/*class holiday {
    ...
    public function __construct($tyear, $tmounth, $tweekOfMonth, $tdayOfWeek, $tday) {
        $year = $tyear;
        $mounth = $tmounth;
        $weekOfMonth = $tweekOfMonth;
...
function checkDateMy($Str) {
    /*if (strlen($Str) < 6 || $Str{2}!="." || (strlen($Str) != 8 && strlen($Str)>5 && strlen($Str)<11) || ((strlen($Str) == 8 || strlen($Str) == 10) && $Str{5}!=".") || (strlen($Str) != 10 && strlen($Str)>8)) {
            return false;
        }*/
